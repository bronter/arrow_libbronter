...
// QuickSort
export extern def qsort(
  base: *byte, num: int64, size: int64,
  compar: (*byte, *byte) -> int);

// Binary Search
export extern def bsearch(
  key: *byte, base: *byte, num: int64, size: int64,
  compar: (*byte, *byte) -> int) -> *int64;
...
export extern def memmove(
  dest: *mutable byte, src: *mutable byte, num: uint64) -> *mutable byte;
// <stdio.h>
// =============================================================================
